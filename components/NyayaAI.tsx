...
function answer(question: string): Reply {
  ...
  if (query.includes("track") || query.includes("case") || query.includes("cnr")) return { text: "You can search the bundled synthetic unified case from the home page. Try NYA-WB-DEMO-04821.", action: { label: "Search a demo case", href: "/#track" } };
  ...
  if (query.includes("guide") || query.includes("understand") || query.includes("happen")) return { text: "Nyaya Guide explains common court concepts in plain language. It is educational prototype content, not legal advice.", action: { label: "Open Nyaya Guide", href: "/guide" } };
