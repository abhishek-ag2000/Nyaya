...
export const roleConfig: Record<Role, RoleConfig> = {
  citizen: { label: "Citizen / Litigant", workspace: "My Nyaya", home: "/citizen", icon: Landmark, tabs: ["Overview", "Timeline", "Documents", "Hearings"], navigation: [{ label: "My Nyaya", href: "/citizen" }, { label: "Today’s Matters", href: "/today" }, { label: "Hearings", href: "/hearings" }, { label: "My Cases", href: "/my-cases" }], actions: [{ label: "Today’s matters", href: "/today" }, { label: "Get legal help", href: "/get-help" }], priority: ["My cases", "Next hearing"] },
  ...
  judge: { label: "Judge", workspace: "My Court", home: "/judge", icon: Gavel, tabs: ["Overview", "Timeline", "Filings", "Documents", "Hearings", "Readiness"], courtName: "District & Sessions Court, Darjeeling", navigation: [{ label: "My Court", href: "/judge" }, { label: "Today’s Matters", href: "/today" }, { label: "Hearings", href: "/hearings" }, { label: "My Cases", href: "/my-cases" }], actions: [{ label: "Open today’s docket", href: "/today" }, { label: "Review case readiness", href: "/cases/NYA-WB-DEMO-04821" }, { label: "Open court information", href: "/courts" }], priority: ["Today’s docket", "Readiness", "Pending applications", "Long-pending matters"] },
...
const workspacePrefixes = ["/citizen", "/advocate", "/judge", "/registry", "/stenographer", "/police", "/today", "/hearings", "/my-cases", "/filing-defects", "/file-a-case", "/cases", "/notifications", "/profile", "/certified-copy"] as const;
