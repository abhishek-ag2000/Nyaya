...
export default function GuidePage() {
  return <><Disclaimer /><Header /><main className="guide-page">
    <section className="wrap guide-hero"><p className="kicker">Nyaya Guide</p><h1>Understand the process.<br /><em>Not just the status.</em></h1><p>Plain-language, educational guidance for navigating common court concepts. It is not legal advice and never replaces a lawyer or court record.</p><div className="guide-search">⌕ <span>What do you want to understand?</span></div></section>
    ...
    <section className="guide-note"><div className="wrap"><p className="kicker">Contextual learning</p><h2>Information that meets you at the right stage.</h2><p>When viewing a case, Nyaya can point to relevant explanations like “What happens during a hearing?” or “What does this stage mean?” All learning content on this site is designed-only.</p><Link className="outline-cta" href="/cases/NYA-WB-DEMO-04821">View the unified demo case <span>→</span></Link></div></section>
  </main><Footer /></>;
}
