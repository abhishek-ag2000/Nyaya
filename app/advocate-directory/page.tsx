...
export const metadata = createPageMetadata("Lawyers Directory", "Browse fictional lawyer profiles by district, court, and practice area in this clearly labeled digital-courts.", "/advocate-directory");
